...
const SocialIcon = ({ kind, href, size = 8, theme }: SocialIconProps) => {
  ...
  return (
    ...
    >
      ...
      <SocialSvg width={size * 4} height={size * 4} />
    </a>
  );
};
...
export function Xiaohongshu(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <button className="flex items-center justify-center w-6 h-6 bg-red-500 text-white rounded-full shadow hover:bg-red-600">
