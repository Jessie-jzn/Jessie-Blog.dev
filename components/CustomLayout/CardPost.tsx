...
const CardPost = ({
  ...
  return (
    <div className="p-6 rounded-lg shadow-md text-gray-600 dark:text-white">
      <Link href={`/post/${id}`} className="flex flex-col items-center">
        <Image
          src={
            imageSrc ||
            "https://www.dropbox.com/scl/fi/p5jykwuc23gopzf7dnpnd/image1.webp?rlkey=q59ji1f207siy21n7t27uatdx&st=7r1p4qlj&raw=1"
          }
          alt={title}
